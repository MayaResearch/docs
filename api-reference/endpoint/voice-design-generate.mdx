...
<ParamField body="character_id" type="string" required default="mfbo7r">
  The unique identifier of a pre-designed character from the Get Characters endpoint
  
  **Available Characters:**
  - `mfbo7r` - British 20s female
  - `mzakoa` - British 20s male
  - `m01ksa` - American 20s male
  - `mxq9oh` - American 40s male
  - `mu4o6g` - American 40s female
  - `mx2zt5` - British 40s female
  - `mxuv0j` - British 40s male
</ParamField>
